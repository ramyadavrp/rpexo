                    ...
                    <div class="col-lg-6 col-12">
                        ...
                        <div class="product-gallery">
                            ...
                            <div class="flexslider-thumbnails">
                                <ul class="slides">
                                    @php $photo=explode(',',$product_detail->photo); // dd($photo); @endphp @foreach($photo as $data)

                                    <li data-thumb="{{$data}}" rel="adjustX:10, adjustY:">
                                        <a target="_blank" data-fancybox="" class="zoom_image" data-src="{{$data}}"><img src="{{$data}}" class="img-responsive template_images zoomD" style="border: 2px solid transparent; border-radius: 3px;">
                                        </a>
                        ...
                        <div class="product-des">
                            ...
                            <div class="short">
                                ...
                                <div class="rating-main">
                                    <ul class="rating">
                                        @php $rate=ceil($product_detail->getReview->avg('rate')) @endphp @for($i=1; $i
                                        <=5; $i++) @if($rate>=$i)
                                                ...
                                                <div class="ratting-main">
                                                    ...
                                                    <div class="single-rating">
                                                        <div class="rating-author">
                                                            ...
                                                            <img src="{{$data->user_info['photo']}}" alt="{{$data->user_info['photo']}}"> @else
                                                            <img src="{{asset('backend/img/avatar.png')}}" alt="Profile.jpg"> @endif
                                                        </div>
        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="owl-carousel popular-slider">
                    @foreach($product_detail->rel_prods as $data) @if($data->id !==$product_detail->id)
...
<script>
    $(document).ready(function () {
        $('img.zoomD').each(function () {

            $img = $(this).attr('src');
           
            $(this).closest('a').removeAttr('target');
            $(this).wrap('<a target="_blank" data-fancybox="" class="zoom_image" data-src="' + $img + '"></a>');
            console.log($img);
        });
        $('body').on('click', '.zoom_image', function (e) {
